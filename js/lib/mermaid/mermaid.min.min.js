...
*/window.addEventListener("load",function(){On()},!1);const Ln={startOnLoad:!0,htmlLabels:!0,mermaidAPI:Cn,parse:Cn.parse,render:Cn.render,init:function(){const t=Cn.getConfig();let e,n,r;b.debug("Starting rendering diagrams"),arguments.length>=2?(/*!sequence config was passed as #1*/void 0!==arguments[0]&&(Ln.sequenceConfig=arguments[0]),e=arguments[1]):e=arguments[0],"function"==typeof arguments[arguments.length-1]?(n=arguments[arguments.length-1],b.debug("Callback function found")):void 0!==t.mermaid&&("function"==typeof t.mermaid.callback?(n=t.mermaid.callback,b.debug("Callback function found")):b.debug("No Callback function found")),e=void 0===e?document.querySelectorAll(".mermaid"):"string"==typeof e?document.querySelectorAll(e):e instanceof window.Node?[e]:e,b.debug("Start On Load before: "+Ln.startOnLoad),void 0!==Ln.startOnLoad&&(b.debug("Start On Load inner: "+Ln.startOnLoad),Cn.initialize({startOnLoad:Ln.startOnLoad})),void 0!==Ln.ganttConfig&&Cn.initialize({gantt:Ln.ganttConfig});for(let t=0;t<e.length;t++){const a=e[t];/*!Check if previously processed*/if(a.getAttribute("data-processed"))continue;a.setAttribute("data-processed",!0);const o=`mermaid-${Date.now()}`;r=a.innerHTML,r=i.a.decode(r).trim().replace(/<br>/gi,"<br/>"),Cn.render(o,r,(t,e)=>{a.innerHTML=t,void 0!==n&&n(o),e&&e(a)},a)}},initialize:function(t){b.debug("Initializing mermaid "),void 0!==t.mermaid&&(void 0!==t.mermaid.startOnLoad&&(Ln.startOnLoad=t.mermaid.startOnLoad),void 0!==t.mermaid.htmlLabels&&(Ln.htmlLabels=t.mermaid.htmlLabels)),Cn.initialize(t)},contentLoaded:On};e.default=Ln}]).default});